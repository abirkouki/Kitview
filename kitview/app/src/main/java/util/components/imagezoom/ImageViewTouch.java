package util.components.imagezoom;

import util.components.gallery.RecyclingBitmapDrawable;
...
/**Merged with RecyclingImageView
 * 
 * NEW onDetachedFromWindow
 * **/
...
public class ImageViewTouch extends ImageViewTouchBase {
	...
	/**NEW Merged with RecyclingImageView**/
	...
	/**End merge with RecyclingImageView**/
	...
	public boolean onTouchEvent(MotionEvent event) {		
		//Log.e("index:","index:"+event.getActionIndex()+"masked:"+event.getActionMasked()+" action:"+event.getAction());

...
package util.network.discovery.Utils;

import util.network.discovery.Network.DownloadFile;
...
public class Db {
    ...
    public static final String PATH = "/data/data/com.dentalcrm.kitview/files/";

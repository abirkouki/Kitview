...
public class ImageCache {
	 ...
	 */
	public Bitmap getBitmapFromDiskCache(String data,int mImageWidth, int mImageHeight) {
		final String key = hashKeyForDisk(data);
		Bitmap bitmap = null; 
				...
				try {
					...
					if (snapshot != null) {
						...
						if (inputStream != null) {
							...
							bitmap = ImageResizer.decodeSampledBitmapFromDescriptor(
									fd, mImageWidth, mImageHeight, this);
	 ...
	 *         created.
	 */
	//NEW: visibility change to public (private)
	public static RetainFragment findOrCreateRetainFragment(android.app.FragmentManager fm) {
	//public static android.app.Fragment findOrCreateRetainFragment(android.app.FragmentManager fm) {
		
		// Check to see if we have retained the worker fragment.
		RetainFragment mRetainFragment = (RetainFragment) fm.findFragmentByTag(TAG);
		//android.app.Fragment mRetainFragment = (android.app.Fragment) fm.findFragmentByTag(TAG);
		

		// Log.e("mRetainFragment","mRetainFragment:"+mRetainFragment);
	...
	public static RetainFragment findRetainFragment(android.app.FragmentManager fm) {
		// Check to see if we have retained the worker fragment.

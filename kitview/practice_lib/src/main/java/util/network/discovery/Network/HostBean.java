...
public class HostBean implements Parcelable {
    ...
    public static final String EXTRA_POSITION = ActivityDiscovery.PKG + ".extra_position";
    public static final String EXTRA_HOST = ActivityDiscovery.PKG + ".extra_host";
    public static final String EXTRA_TIMEOUT = ActivityDiscovery.PKG + ".network.extra_timeout";
    public static final String EXTRA_HOSTNAME = ActivityDiscovery.PKG + ".extra_hostname";
    public static final String EXTRA_BANNERS = ActivityDiscovery.PKG + ".extra_banners";
    public static final String EXTRA_PORTSO = ActivityDiscovery.PKG + ".extra_ports_o";
    public static final String EXTRA_PORTSC = ActivityDiscovery.PKG + ".extra_ports_c";
    public static final String EXTRA_SERVICES = ActivityDiscovery.PKG + ".extra_services";
    ...
    public boolean isKitViewAvailable = false;
    public boolean isStreamingServerAvailable = false;

...
import view.level.LevelPreferences;
import view.level.config.DisplayType;
import view.level.config.Viscosity;
...
public class LevelView2 extends View {
	...
	public LevelView2(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public LevelView2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		setSurfaceSize(newWidth, newHeight);
	}
	...
	private void initialize(Context context){
		...
		DisplayType angleType = DisplayType.valueOf(prefs.getString(LevelPreferences.KEY_DISPLAY_TYPE, "ANGLE"));
		Viscosity viscosity = Viscosity.valueOf(prefs.getString(LevelPreferences.KEY_VISCOSITY, "MEDIUM"));
		...
		// config
		this.showAngle = false;//showAngle;
		...
		// init
		this.locked = false;
		this.lockEnabled = false;//lockEnabled;
